...
/*
    ...
    Fecha: 25-03-2025
    Resumen: Recoge el id del partido y la accion a ejecutar, aceptar o rechazar el partido,
    y establece en aceptado el estado en caso de aceptar y lo elimina en caso de rechazar,
    pero envia un correo al usuario que actuo como local.
*/

...
/*
    ...
    Fecha: 25-03-2025
    Resumen: Obtiene por el URL el correo y substrae el nombre y apellidos del usuario,
    se busca un partido con estado igual a pendiente y con nombre completo del usuario
    igual al visitante del partido.
*/

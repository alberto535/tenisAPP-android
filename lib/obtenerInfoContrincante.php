...
/*
    ...
    Fecha: 23-03-2025
    Resumen: Se obtiene por URL el correo que se usa para buscar informacion en la tabla usuarios,
    realiza una comparacion de los partidos de la jornada actual con el nombre y apellidos del
    usuario logueado, para obtener el partido y el nombre del contrincante. Y se substraen los
    datos del contrincante y se envian.
*/

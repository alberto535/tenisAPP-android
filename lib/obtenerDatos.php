...
/*
    ...
    Fecha: 23-03-2025
    Resumen: Se substrae de la tabla usuarios algo de informacion sobre el usuario logueado,
    para realizar una seleccion y muestra de informacion de su partido, si se encuentra como
    jugador local, y envia los datos obtenidos.
*/

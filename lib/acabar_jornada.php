...
/*
    ...
    Fecha: 06-04-2025
    Resumen: Se establece en la tabla clasificacion la puntuacion de los jugadores que jugaron
    esta jornada, a la jornada actual se le establece fecha de fin, se genera una nueva jornada
    y establece el estado como procesado de los partidos.
 */
...
// ✅ Asegurar que se recibe la liga por GET
if (!isset($_GET['liga']) || empty($_GET['liga'])) {
    die("Liga no especificada.");
}
$liga = $conn->real_escape_string($_GET['liga']);

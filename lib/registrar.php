...
/*
    ...
    Fecha: 16-03-2025
    Resumen: Recoge por metodo POST los datos introducidos en el formulario y realiza una
    serie de comprobaciones sobre los datos. Y si son correctos, se introducen los datos

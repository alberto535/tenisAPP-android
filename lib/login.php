...
/*
    ...
    Fecha: 16-03-2025
    Resumen: Recoge por el URL el correo y contraseña, y comprueba si se trata de un
    administrador o un usuario, he inicia sesion, otorgandole valores a las variables de la sesion.
*/

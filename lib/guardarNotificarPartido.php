...
/*
    ...
    Fecha: 23-03-2025
    Resumen: Se recoge con POST informacion acerca del formulario de insertar un resultado,
    se establece el id del partido y se introducen los datos en la tabla partidos.
*/

...
/*
    ...
    Fecha: 30-03-2025
    Resumen: Inserta en la tabla ligas con los datos recibidos, introduce la fecha de creacion
    y el nombre. Y establece tambien la liga y division para los jugadores seleccionados
    anteriormente.
 */
